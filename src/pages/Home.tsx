  ...
  const steps = [
    {
      ...
      title: 'Reach Out',
      description:
        'Tell us about your project needs and challenges.',
    },
    {
      number: '02',
    ...
    },
    {
      ...
      description:
        'We deliver, install, and configure systems professionally.',
    },
    {
      number: '04',
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            Smart Solutions for
            <br />
            <span style={{ color: '#a7fc00' }}>Security, ICT and Business Operations</span>
          </h1>
          <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            We design and deploy practical, secure and reliable solutions that help 
            organizations operate safely, manage projects effectively and achieve better results.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everything you need to build, manage, and scale your business with confidence
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {[
              { number: '+30', label: 'Completed Projects Across public and private sector clients' },
              { number: '100%', label: 'Client Satisfaction Focus Quality work and transparent communication' },
              { number: '24/7', label: 'Professional technical assistance when needed' },
              { number: 'Growing Partnerships', label: 'Expanding across industries and sectors' },
            ].map((stat, index) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Let’s work together to design secure, reliable and efficient solutions 
