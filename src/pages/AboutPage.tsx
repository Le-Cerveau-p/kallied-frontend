        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <br />
              <span style={{ color: '#4169e1' }}>Security, Technology and Infrastructure</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              K-Allied Integrated Solutions delivers reliable, practical and secure solutions across ICT,
              security systems, power, procurement and infrastructure support services. 
              We exist to help organizations operate safer, smarter and more efficiently — 
              with solutions designed for real-world environments.
            </p>
          </div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 border-2 border-gray-200 hover:border-[#4169e1] transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  Our mission is to provide dependable, innovative and affordable solutions 
                  that enhance safety, improve operations, and empower organizations across Africa and beyond. 

                  We aim to bridge gaps between technology, security, power and project delivery — 
                  ensuring businesses can focus on what matters most.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 border-2 border-gray-200 hover:border-[#4169e1] transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  To become a leading African solutions provider known for integrity, 
                  technical excellence and customer-focused delivery — creating safer 
                  and more efficient environments for businesses, governments and communities.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
                  Whether you need reliable ICT infrastructure, security systems,
energy support or professional consulting — our team is ready to help.
                </p>
