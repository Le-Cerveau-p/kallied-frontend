...
export default function StaffDashboard() {
  ...
  const stats = [
    { id: 1, label: 'Assigned Tasks', value: '12', icon: CheckSquare, color: '#4169e1', bgColor: '#e3f2fd' },
    { id: 2, label: 'Tasks Due Soon', value: '4', icon: Clock, color: '#ff9800', bgColor: '#fff3e0' },
    { id: 3, label: 'Completed Tasks', value: '28', icon: CheckCircle2, color: '#4caf50', bgColor: '#e8f5e9' },
    { id: 4, label: 'Notifications', value: '7', icon: Bell, color: '#d4183d', bgColor: '#ffebee' },
  ];
  ...
  const notifications = [
    {
      ...
      type: 'comment',
      user: 'Sarah Johnson',
      message: 'Commented on "Q1 Financial Report" - Please review the updated figures in section 3.',
      time: '15 minutes ago',
      isUnread: true,
    },
    {
    ...
    },
    {
      ...
      type: 'comment',
      user: 'Mike Chen',
      message: 'Mentioned you in "Sales Presentation" - Can you help with the analytics section?',
      time: '3 hours ago',
      isUnread: false,
    },
    {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {/* Page Heading */}
          <div className="mb-8">
            <h1 className="text-4xl" style={{ color: '#001f54' }}>My Work Dashboard</h1>
            <p className="text-gray-600 mt-2">Track your tasks, projects, and stay productive</p>
          </div>
            ...
            {stats.map((stat) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-3xl font-semibold" style={{ color: '#001f54' }}>
                    {stat.value}
                  </p>
                </div>
              );
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <h4 className="font-medium mb-1" style={{ color: '#001f54' }}>
                            {task.title}
                          </h4>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-semibold" style={{ color: '#4caf50' }}>
                      8
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Hours Logged</span>
                    <span className="text-lg font-semibold" style={{ color: '#4169e1' }}>
                      32
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Reports Submitted</span>
                    <span className="text-lg font-semibold" style={{ color: '#9c27b0' }}>
                      3
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              {notifications.map((notification) => (
                <div
                  ...
                  style={{
                    borderLeftColor: notification.isUnread ? '#4169e1' : '#e0e0e0',
                  }}
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <p className="font-medium text-sm" style={{ color: '#001f54' }}>
                          {notification.user}
                        </p>
